(function () {
  ...
  var events = [
    ...
    },
    {
      ...
      description: "별도 예약 없이 누구나 새해 첫 일출을 나만의 시선으로 담아 참가하는 사진 대회입니다. 휴대폰과 카메라 모두 사용할 수 있으며 한 장의 사진을 제출하면 1,000 SEA 포인트를 받을 수 있습니다. 해당 시간은 일출 예정 시간이며, 사진은 당일 23:59까지 제출해 주세요.",
